...
import allpage from "../Assets/allpage.png";

const Privacy = () => {
  return (
    <div className="privacy">
      <div className="object-cover relative">
        <img src={allpage} alt="" className="w-screen h-[300px]" />
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h1 className="text-white text-4xl font-bold">Privacy & Policy</h1>
          <h3 className=" mt-4 bg-white">Home // Privacy & Policy</h3>
        </div>
      </div>
      <div className="ml-16">
        <h3 className="text-3xl font-semibold mb-3">Privacy & Policy</h3>
        <h1 className="text-3xl font-bold mb-2.5">Privacy Policy</h1>
        <h5 className="text-1xl font-semibold mb-3">
        ...
        <p>
          ...
          number, billing address, and other related information. We do not
          store your payment information on our servers; it is securely handled
          by our third-party payment processors. Shipping Information: We
          collect your shipping address and contact information to fulfill your
          orders and ensure timely delivery.
        </p>
        ...
        <p>
          The information we collect is used for a variety of purposes,
          including: Providing and Improving Our Services: We use your
          information to process transactions, fulfill orders, provide customer
          support, and enhance your overall shopping experience.
          ...
          fraudulent activities. Legal Compliance: We may use your data to
          comply with legal obligations, enforce our terms and conditions, and
          respond to legal requests or inquiries.
        </p>
        <h1 className="text-3xl font-bold mb-2.5">
        ...
        <p>
          ...
          may share your information with trusted partners and service providers
          for the following purposes: Service Providers: We work with
          third-party companies to provide services such as payment processing,
          ...
          owner as part of the transaction. Legal Requirements: We may disclose
          your information if required by law or in response to a legal process,
        ...
        <p>
          ...
          copy of the personal information we hold about you in a structured,
          commonly used, and machine-readable format. Deletion: You can request
          the deletion of your account and personal information by contacting
          our customer support team. Please note that we may retain certain
          information as required by law or for legitimate business purposes.
        </p>
        <h1 className="text-3xl font-bold mb-2.5">5. Data Security</h1>
        <p>
          We take the security of your personal information seriously and
          implement a variety of measures to protect it. These include
          encryption, access controls, and regular security audits. However, no
        ...
        <p>
          ...
          your cookie preferences through your browser settings. However,
          disabling cookies may affect the functionality of our site and your
        ...
        <p>
          ...
          the top of this page and notify you through our platform or via email.
          We encourage you to review this Privacy Policy periodically to stay
          informed about how we protect your information.
        </p>
        <h1 className="text-3xl font-bold mb-2.5">11. Contact Us</h1>
        <p>
          If you have any questions or concerns about this Privacy Policy or our
          data practices, please contact us at: Email: support@geniusshop.com
          Email: support@geniusshop.com
        </p>
      </div>
    </div>
  );
