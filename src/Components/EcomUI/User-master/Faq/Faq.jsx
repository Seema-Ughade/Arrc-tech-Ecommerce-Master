...
//           What is Genius Shop and how does it work?
//         </h2>
//         <p>
//           Genius Shop is a dynamic multivendor eCommerce platform that brings
...
//           Each vendor on Genius Shop manages their own store, allowing them to
...
//           through the Genius Shop interface. Our platform ensures a seamless
//           shopping experience, from product discovery to payment and delivery.
//         </p>

//         <h2 className="text-2xl font-semibold mb-2.5">
//           How do I create an account on Genius Shop and what are the benefits?
//         </h2>
//         <p>
//           Creating an account on Genius Shop is simple and offers a range of
...
//         </p>
//         <h2 className="text-2xl font-semibold mb-2.5">
//           How can I become a seller on Genius Shop, and what are the
//           requirements?
//         </h2>
//         <p>
//           Becoming a seller on Genius Shop is a fantastic opportunity to reach a
...
//           your store and start listing products. As a seller on Genius Shop,
//           you’ll gain access to our robust platform tools that help manage
//           inventory, process orders, and communicate with customers.
//         </p>

//         <h2 className="text-2xl font-semibold mb-2.5">
//           How do I place an order on Genius Shop, and what should I know before
//           purchasing?
//         </h2>
//         <p>
//           Placing an order on Genius Shop is designed to be straightforward and
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           What payment methods does Genius Shop accept, and are transactions
//           secure?
//         </h2>
//         <p>
//           Genius Shop accepts a variety of payment methods to make your shopping
...
//           methods depending on your location. All transactions on Genius Shop
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           Can I track my order on Genius Shop, and how does the tracking process
//           work?
//         </h2>
//         <p>
//           Yes, Genius Shop provides a comprehensive order tracking system to
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           What is the return policy on Genius Shop, and how do I return a
//           product?
//         </h2>
//         <p>
//           The return policy on Genius Shop is designed to be as fair and
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           How do I contact Genius Shop customer support, and what kind of
//           assistance is available?
//         </h2>
//         <p>
//           If you need assistance with anything related to your Genius Shop
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           Are there any shipping charges on Genius Shop, and how are they
//           calculated?
//         </h2>
//         <p>
//           Shipping charges on Genius Shop can vary depending on several factors,
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           How do i leave a review for a product on Genius shop, and why is it
//           important?
//         </h2>
//         <p>
//           Leaving a review on Genius Shop is a great way to share your
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           How do I Know if a seller on Genius Shop is trustworthy?
//         </h2>
//         <p>
//           At Genius Shop, we prioritize creating a safe and reliable marketplace
...
//           item as evidence. Then, log in to your Genius Shop account and go to
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           {" "}
//           Can i cancel my order on Genius shop , and what are the conditions?
//         </h2>
//         <p>
//           Yes, you can cancel your order on Genius Shop, but the ability to do
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           Does Genius Shop offer any promotions or discounts, and how can I find
//           them?
//         </h2>
//         <p>
//           Yes, Genius Shop frequently offers promotions, discounts, and special
...
//         <h2 className="text-2xl font-semibold mb-2.5">
//           What steps does Genius shop take to ensure product authenticity?
//         </h2>
//         <p>
//           Genius Shop is committed to offering only genuine and authentic
