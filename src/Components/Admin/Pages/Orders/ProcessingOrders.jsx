...
const ProcessingOrders = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      const dummyData = [
        { customerEmail: "janedoe@example.com", orderNumber: "Jhnk1732198765", totalQty: 2, totalCost: 149.75 },
        { customerEmail: "mark123@gmail.com", orderNumber: "Mktt1733309021", totalQty: 3, totalCost: 450.50 },
        { customerEmail: "susan.smith@mail.com", orderNumber: "Ssmx1733140192", totalQty: 1, totalCost: 120.25 },
            ];
      setOrders(dummyData);
