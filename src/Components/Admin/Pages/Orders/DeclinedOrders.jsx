...
const DeclinedOrders = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      const dummyData = [
        { customerEmail: "user@gmail.com", orderNumber: "gTy81717315508", totalQty: 1, totalCost: 46.42 },
      ];
      setOrders(dummyData);
  ...
  return (
    <div className="container mx-auto">
      <div className="content-area">
        <h4 className="heading text-purple-600 text-2xl font-semibold mb-4">
          Declined Orders
        </h4>
        ...
        <div className="flex justify-between mb-4">
          <input
            type="text"
            placeholder="Search declined orders..."
            value={searchTerm}
